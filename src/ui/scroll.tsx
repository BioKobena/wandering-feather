      ...
      <div className="flex flex-col justify-center items-center gap-4">
        <h1
          className={isMobile
            ...
            : "font-departure  font-(family-name:--font-karla) font-bold text-5xl relative z-10 text-center h-[120px] md:h-auto leading-tight text-white border w-lg p-1 bg-slate-800 hover:bg-white hover:text-black rounded-xs"}
        >
          Derniers poèmes
        </h1>
