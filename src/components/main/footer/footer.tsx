                ...
                <div className="sm:container  px-4 mx-auto">
                    <div className="md:flex justify-between w-full">
                        <div>
                            <h1 className="md:text-4xl text-2xl font-semibold">
                                Pour une plume sincère et un écho universel.
                        ...
                        <div className="flex gap-10">
                            <ul>
                                ...
                                <li className="text-xl font-medium">
                                    <Link href="/about">Poèmes</Link>
                                </li>
                                <li className="text-xl font-medium">
                                    <Link href="/services">À propos</Link>
                                </li>

                                <li className="text-xl font-medium">
                                    <Link href="/projects">Inspirations</Link>
                                </li>
                                <li className="text-xl font-medium">
                    ...
                    <div className="flex text-center md:flex-row flex-col-reverse gap-3 justify-between py-2">
                        <span className="font-medium  text-center">
                            &copy; {date} kobejs. All Rights Reserved.
                        </span>
                    </div>
                </div>
            </div>
