...
function Index() {
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center p-4 gap-8 text-white mt-20 xl:mt-32">
      ...
      <div className="flex flex-col-reverse xl:flex-row-reverse w-full h-full">
        <div className="w-full xl:w-1/2 flex items-center justify-center px-6 xl:px-20 py-12">
          <article className="flex flex-col gap-4 max-w-3xl">
            <span className="inline-block text-lg sm:text-sm border p-1 px-3 w-fit rounded-full border-[#3273ff] bg-[#0f1c35]">
              Bienvenue sur mon blog
            </span>
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-2xl font-semibold bg-gradient-to-b from-[#edeffd] to-[#7b9cda] bg-clip-text text-transparent leading-tight tracking-tight">
      ...
      <div className="w-full max-w-6xl flex flex-col items-center justify-center mt-4 px-4">
